...
export function TeamLeaderInfo({ isOpen, onOpenChange }: TeamLeaderInfoProps) {
          ...
          <CardContent className="pb-[20px] p-0 pt-[5px]">
            ...
            <div className="pt-[5px]">
              <div className="flex items-center gap-2 mt-1">
                <p className="text-sm font-semibold">Number of members:</p>
                <p className="text-sm font-normal text-gray-500">4</p>
              </div>
              ...
              <div className="flex items-center gap-2 mt-2">
                ...
                <p className="text-sm font-normal text-gray-500">9876543210</p>
              </div>
            </div>
